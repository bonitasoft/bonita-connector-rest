...
import org.bonitasoft.restresult.RESTResult;
...
public class RESTConnector extends AbstractRESTConnector {
	...
	final static private String POST_STR = "POST";
	final static private String PUT_STR = "PUT";
	final static private String DELETE_STR = "DELETE";
	...
	static public HTTPMethod getHTTPMethod(String input) {
		if(input != null) {
			if(GET_STR.equals(input)) {
				return HTTPMethod.GET;
			}
			if(POST_STR.equals(input)) {
				return HTTPMethod.POST;
			}
			if(PUT_STR.equals(input)) {
				return HTTPMethod.PUT;
			}
			if(DELETE_STR.equals(input)) {
